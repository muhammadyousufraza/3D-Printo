...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'haru-teespace' ),
			'defaultString' => esc_html__( 'Default', 'haru-teespace' ),
			'pick'          => esc_html__( 'Select Color', 'haru-teespace' ),
			'current'       => esc_html__( 'Current Color', 'haru-teespace' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'haru-teespace' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'haru-teespace' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'haru-teespace' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'haru-teespace' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'haru-teespace' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'haru-teespace' ) ),
					'nextText'        => esc_html__( 'Next', 'haru-teespace' ),
					'prevText'        => esc_html__( 'Prev', 'haru-teespace' ),
					'currentText'     => esc_html__( 'Today', 'haru-teespace' ),
					'closeText'       => esc_html__( 'Done', 'haru-teespace' ),
					'clearText'       => esc_html__( 'Clear', 'haru-teespace' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'haru-teespace' ),
					'timeText'      => esc_html__( 'Time', 'haru-teespace' ),
					'hourText'      => esc_html__( 'Hour', 'haru-teespace' ),
					'minuteText'    => esc_html__( 'Minute', 'haru-teespace' ),
					'secondText'    => esc_html__( 'Second', 'haru-teespace' ),
					'currentText'   => esc_html__( 'Now', 'haru-teespace' ),
					'closeText'     => esc_html__( 'Done', 'haru-teespace' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'haru-teespace' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'haru-teespace' ),
				'upload_files' => esc_html__( 'Use these files', 'haru-teespace' ),
				'remove_image' => esc_html__( 'Remove Image', 'haru-teespace' ),
				'remove_file'  => esc_html__( 'Remove', 'haru-teespace' ),
				'file'         => esc_html__( 'File:', 'haru-teespace' ),
				'download'     => esc_html__( 'Download', 'haru-teespace' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'haru-teespace' ),
			),
		);
