...
if ( ! class_exists( 'Haru_TeeSpace_Images_Gallery_Widget' ) ) {
	class Haru_TeeSpace_Images_Gallery_Widget extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Haru Images Gallery', 'haru-teespace' );
		}
		...
		protected function register_controls() {
	        ...
	        $this->add_control(
				'pre_style',
				[
					'label' => __( 'Pre Images Gallery', 'haru-teespace' ),
					'description' 	=> __( 'If you choose Pre Images Gallery you will use Style default from our theme.', 'haru-teespace' ),
            ...
            $this->add_control(
                ...
                [
                    ...
                    'raw' => '<strong>' . __( 'You can set Slide Options if you set Pre Images Gallery is Slick layout.', 'haru-teespace' ) . '</strong><br>',
            ...
            $this->add_control(
                ...
                [
                    'type' => Controls_Manager::RAW_HTML,
                    'raw' => '<strong>' . __( 'You can set Grid Options if you set Pre Images Gallery is Grid layout.', 'haru-teespace' ) . '</strong><br>',
                    'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
                ]
            );
