...
if ( ! class_exists( 'Haru_TeeSpace_Episode_Category_Widget' ) ) {
    class Haru_TeeSpace_Episode_Category_Widget extends Widget_Base {

        public function get_name() {
            return 'haru-episode-category';
        }

        public function get_title() {
            return esc_html__( 'Haru Episode Category', 'haru-teespace' );
        }
        ...
        protected function register_controls() {
            ...
            $post_types = array();
            $post_types['haru_episode'] = __( 'Episodes', 'haru-teespace' );
            $post_types['by_id'] = __( 'Manual Selection', 'haru-teespace' );

            $taxonomies = get_taxonomies( [ 'object_type' => [ 'haru_episode' ] ], 'objects' );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '',
                    'title' => __( 'Widget Title', 'haru-teespace' ),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => ControlsHelper::get_post_list('haru_episode'),
                    'label_block' => true,
                    'multiple' => true,
                    'condition' => [
                        'post_type' => 'by_id',
            ...
            $this->add_control(
                'episode_style',
                [
                  'label' => __( 'Episode Style', 'haru-teespace' ),
                  'type' => Controls_Manager::SELECT,
                  'default' => 'style-1',
                  'options' => [
            ...
            $this->add_control(
                'episode_padding',
                [
                  'label' => __( 'Episode Padding', 'haru-teespace' ),
                  'type' => Controls_Manager::SELECT,
                  'default' => 'no-padding',
                  'options' => [
            ...
            $this->add_control(
                'episode_filter',
                [
                  'label' => __( 'Episode Filter', 'haru-teespace' ),
                  'type' => Controls_Manager::SELECT,
                  'default' => 'hide',
                  'options' => [
            ...
            $this->add_control(
                'episode_filter_all',
                [
                    'label' => __( 'Episode Filter All', 'haru-teespace' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'show',
                    'options' => [
            ...
            $this->add_responsive_control(
                'episode_filter_align',
                [
                    'label' => __( 'Episode Filter Align', 'haru-teespace' ),
                    ...
                    'default' => 'left',
                    'selectors' => [
                        '{{WRAPPER}} .episode-filter' => 'text-align: {{VALUE}};',
                    ],
                    'condition' => [
                        'episode_filter!' => [ '' ],
                    ],
        ...
        protected function render() {
            ...
            $this->add_render_attribute( 'episode', 'class', 'haru-episode-category' );

            $this->add_render_attribute( 'episode', 'class', 'haru-episode-category--' . $settings['layout'] );

            $this->add_render_attribute( 'episode', 'class', 'haru-episode-category--' . $settings['episode_padding'] );

            $this->add_render_attribute( 'episode', 'id', 'haru-episode-category' . rand() );

            $this->add_render_attribute( 'episode', 'data-settings', htmlentities( json_encode( $settings ) ) );

            if ( ! empty( $settings['el_class'] ) ) {
                $this->add_render_attribute( 'episode', 'class', $settings['el_class'] );
            }
            ...
            <?php endif; ?>
                <div <?php echo $this->get_render_attribute_string( 'episode' ); ?>>
                    <?php echo Haru_Template::haru_get_template( 'episode-category/episode-category.php', $settings ); ?>
                </div>
            <?php if ( 'yes' == $settings['background_dark'] ) : ?>
                </div>
            <?php endif; ?>
