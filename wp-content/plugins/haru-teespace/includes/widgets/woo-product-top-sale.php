...
if ( ! class_exists( 'Haru_TeeSpace_Woo_Product_Top_Sale_Widget' ) ) {
    class Haru_TeeSpace_Woo_Product_Top_Sale_Widget extends Widget_Base {

        public function get_name() {
            return 'haru-woo-product-top-sale';
        }

        public function get_title() {
            return esc_html__( 'Haru Woo Product Top Sale', 'haru-teespace' );
        }
        ...
        protected function register_controls() {
            ...
            $this->start_controls_section(
                'section_settings',
                [
                    'label'     => esc_html__( 'Product Top Sale Settings', 'haru-teespace' ),
            ...
            $this->add_control(
                'pre_style',
                [
                    'label' => __( 'Pre Product Top Sale', 'haru-teespace' ),
                    'description'   => __( 'If you choose Product Top Sale you will use Style default from our theme.', 'haru-teespace' ),
        ...
        protected function render() {
            ...
            $this->add_render_attribute( 'product-top-sale', 'class', 'haru-product-top-sale' );

            if ( ! empty( $settings['el_class'] ) ) {
                $this->add_render_attribute( 'product-top-sale', 'class', $settings['el_class'] );
            }
            ?>

            <div <?php echo $this->get_render_attribute_string( 'product-top-sale' ); ?>>
                <?php echo Haru_Template::haru_get_template( 'woo-product-top-sale/woo-product-top-sale.php', $settings ); ?>
            </div>
