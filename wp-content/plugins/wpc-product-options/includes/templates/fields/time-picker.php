...
<div class="wpcpo-item-line">
    ...
    <select name="<?php echo esc_attr( 'wpcpo-fields[' . $this->field_id . '][format]' ); ?>">
        <option value="g:i a" <?php selected( $this->get_field_value( 'format' ), 'g:i a' ); ?>><?php echo wp_date( 'g:i a' ); ?></option>
        <option value="g:i A" <?php selected( $this->get_field_value( 'format' ), 'g:i A' ); ?>><?php echo wp_date( 'g:i A' ); ?></option>
        <option value="H:i" <?php selected( $this->get_field_value( 'format' ), 'H:i' ); ?>><?php echo wp_date( 'H:i' ); ?></option>
    </select>
</div>
<div class="wpcpo-item-line">
    <label>
