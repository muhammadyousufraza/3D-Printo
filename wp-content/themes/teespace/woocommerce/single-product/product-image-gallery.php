...
// Process options
$single_product_thumbnail_columns = get_post_meta( get_the_ID(), 'haru_product' . 'gallery_thumb_columns', true );
...
$single_product_thumbnail_position = get_post_meta( get_the_ID(), 'haru_product' . 'gallery_thumb_position', true );
