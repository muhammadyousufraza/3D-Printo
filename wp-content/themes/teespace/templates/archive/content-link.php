...
$url    = get_post_meta( get_the_ID(), 'haru_post_link_url', true );
$text   = get_post_meta( get_the_ID(), 'haru_post_link_text', true );
    ...
    <div class="post-wrap">    
        <div class="post-link-wrap">          
            <div class="post-content-link">
                <?php if ( ! $url || ! $text ) : ?>
                    <div class="post-set-link">
                        <?php echo esc_html__( 'Please set correct link!', 'teespace' ); ?>
                    </div>
                <?php else : ?>
